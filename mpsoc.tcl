...
proc create_root_design { parentCell } {
  ...
  set Result [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Result ]
  set Result1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Result1 ]
  set Result2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Result2 ]
  set Result3 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Result3 ]

  set alu1_A [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 alu1_A ]
  ...
  set alu2_A [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 alu2_A ]
  ...
  set alu3_A [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 alu3_A ]
  ...
  set alu_A [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 alu_A ]
  ...
  # Create ports
  set CarryOut [ create_bd_port -dir I -from 0 -to 0 CarryOut ]
  set CarryOut1 [ create_bd_port -dir I -from 0 -to 0 CarryOut1 ]
  set CarryOut2 [ create_bd_port -dir I -from 0 -to 0 CarryOut2 ]
  set CarryOut3 [ create_bd_port -dir I -from 0 -to 0 CarryOut3 ]

  set Overflow [ create_bd_port -dir I -from 0 -to 0 Overflow ]
  set Overflow1 [ create_bd_port -dir I -from 0 -to 0 Overflow1 ]
  set Overflow2 [ create_bd_port -dir I -from 0 -to 0 Overflow2 ]
  set Overflow3 [ create_bd_port -dir I -from 0 -to 0 Overflow3 ]

  set Zero [ create_bd_port -dir I -from 0 -to 0 Zero ]
  set Zero1 [ create_bd_port -dir I -from 0 -to 0 Zero1 ]
  set Zero2 [ create_bd_port -dir I -from 0 -to 0 Zero2 ]
  set Zero3 [ create_bd_port -dir I -from 0 -to 0 Zero3 ]
  ...
  # Create instance: axi_gpio_alu_op2, and set properties
  set axi_gpio_alu_op2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_alu_op2 ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {0} \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {3} \
  ...
  # Create instance: axi_gpio_alu_op3, and set properties
  set axi_gpio_alu_op3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_alu_op3 ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {0} \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {3} \
  ...
  # Create instance: concat_alu_tag1, and set properties
  set concat_alu_tag1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_alu_tag1 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $concat_alu_tag1

  # Create instance: concat_alu_tag2, and set properties
  set concat_alu_tag2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_alu_tag2 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $concat_alu_tag2

  # Create instance: concat_alu_tag3, and set properties
  set concat_alu_tag3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_alu_tag3 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $concat_alu_tag3
  ...
  connect_bd_intf_net -intf_net axi_gpio_alu_op1_GPIO [get_bd_intf_ports alu1_op] [get_bd_intf_pins axi_gpio_alu_op1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_op2_GPIO [get_bd_intf_ports alu2_op] [get_bd_intf_pins axi_gpio_alu_op2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_op3_GPIO [get_bd_intf_ports alu3_op] [get_bd_intf_pins axi_gpio_alu_op3/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_op_GPIO [get_bd_intf_ports alu_op] [get_bd_intf_pins axi_gpio_alu_op/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_operand1_GPIO [get_bd_intf_ports alu1_A] [get_bd_intf_pins axi_gpio_alu_operand1/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_gpio_alu_operand2_GPIO [get_bd_intf_ports alu2_A] [get_bd_intf_pins axi_gpio_alu_operand2/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_gpio_alu_operand3_GPIO [get_bd_intf_ports alu3_A] [get_bd_intf_pins axi_gpio_alu_operand3/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_gpio_alu_operand_GPIO [get_bd_intf_ports alu_A] [get_bd_intf_pins axi_gpio_alu_operand/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_gpio_alu_res1_GPIO [get_bd_intf_ports Result1] [get_bd_intf_pins axi_gpio_alu_res1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_res2_GPIO [get_bd_intf_ports Result2] [get_bd_intf_pins axi_gpio_alu_res2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_res3_GPIO [get_bd_intf_ports Result3] [get_bd_intf_pins axi_gpio_alu_res3/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_alu_res_GPIO [get_bd_intf_ports Result] [get_bd_intf_pins axi_gpio_alu_res/GPIO]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins axi_gpio_alu_op1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_gpio_alu_res1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_alu_operand2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_alu_op2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins axi_gpio_alu_res2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins axi_gpio_alu_operand3/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins axi_gpio_alu_op3/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins axi_gpio_alu_res3/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M11_AXI]
  ...
  connect_bd_net -net CarryOut1_1 [get_bd_ports CarryOut1] [get_bd_pins concat_alu_tag1/In1]
  connect_bd_net -net CarryOut2_1 [get_bd_ports CarryOut2] [get_bd_pins concat_alu_tag2/In1]
  connect_bd_net -net CarryOut3_1 [get_bd_ports CarryOut3] [get_bd_pins concat_alu_tag3/In1]
  connect_bd_net -net In0_0_1 [get_bd_ports Overflow] [get_bd_pins concat_alu_tag/In0]
  connect_bd_net -net In1_0_1 [get_bd_ports CarryOut] [get_bd_pins concat_alu_tag/In1]
  connect_bd_net -net In2_0_1 [get_bd_ports Zero] [get_bd_pins concat_alu_tag/In2]
  connect_bd_net -net Overflow1_1 [get_bd_ports Overflow1] [get_bd_pins concat_alu_tag1/In0]
  connect_bd_net -net Overflow2_1 [get_bd_ports Overflow2] [get_bd_pins concat_alu_tag2/In0]
  connect_bd_net -net Overflow3_1 [get_bd_ports Overflow3] [get_bd_pins concat_alu_tag3/In0]
  connect_bd_net -net Zero1_1 [get_bd_ports Zero1] [get_bd_pins concat_alu_tag1/In2]
  connect_bd_net -net Zero2_1 [get_bd_ports Zero2] [get_bd_pins concat_alu_tag2/In2]
  connect_bd_net -net Zero3_1 [get_bd_ports Zero3] [get_bd_pins concat_alu_tag3/In2]
  connect_bd_net -net concat_alu_tag1_dout [get_bd_pins axi_gpio_alu_res1/gpio2_io_i] [get_bd_pins concat_alu_tag1/dout]
  connect_bd_net -net concat_alu_tag2_dout [get_bd_pins axi_gpio_alu_res2/gpio2_io_i] [get_bd_pins concat_alu_tag2/dout]
  connect_bd_net -net concat_alu_tag3_dout [get_bd_pins axi_gpio_alu_res3/gpio2_io_i] [get_bd_pins concat_alu_tag3/dout]
  connect_bd_net -net concat_alu_tag_dout [get_bd_pins axi_gpio_alu_res/gpio2_io_i] [get_bd_pins concat_alu_tag/dout]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_gpio_alu_op/s_axi_aresetn] [get_bd_pins axi_gpio_alu_op1/s_axi_aresetn] [get_bd_pins axi_gpio_alu_op2/s_axi_aresetn] [get_bd_pins axi_gpio_alu_op3/s_axi_aresetn] [get_bd_pins axi_gpio_alu_operand/s_axi_aresetn] [get_bd_pins axi_gpio_alu_operand1/s_axi_aresetn] [get_bd_pins axi_gpio_alu_operand2/s_axi_aresetn] [get_bd_pins axi_gpio_alu_operand3/s_axi_aresetn] [get_bd_pins axi_gpio_alu_res/s_axi_aresetn] [get_bd_pins axi_gpio_alu_res1/s_axi_aresetn] [get_bd_pins axi_gpio_alu_res2/s_axi_aresetn] [get_bd_pins axi_gpio_alu_res3/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/M11_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_alu_op/s_axi_aclk] [get_bd_pins axi_gpio_alu_op1/s_axi_aclk] [get_bd_pins axi_gpio_alu_op2/s_axi_aclk] [get_bd_pins axi_gpio_alu_op3/s_axi_aclk] [get_bd_pins axi_gpio_alu_operand/s_axi_aclk] [get_bd_pins axi_gpio_alu_operand1/s_axi_aclk] [get_bd_pins axi_gpio_alu_operand2/s_axi_aclk] [get_bd_pins axi_gpio_alu_operand3/s_axi_aclk] [get_bd_pins axi_gpio_alu_res/s_axi_aclk] [get_bd_pins axi_gpio_alu_res1/s_axi_aclk] [get_bd_pins axi_gpio_alu_res2/s_axi_aclk] [get_bd_pins axi_gpio_alu_res3/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins ps8_0_axi_periph/M10_ACLK] [get_bd_pins ps8_0_axi_periph/M11_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_operand1/S_AXI/Reg] SEG_axi_gpio_alu_operand1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80040000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_op1/S_AXI/Reg] SEG_axi_gpio_alu_op1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80050000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_res1/S_AXI/Reg] SEG_axi_gpio_alu_res1_Reg

  create_bd_addr_seg -range 0x00010000 -offset 0x80060000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_operand2/S_AXI/Reg] SEG_axi_gpio_alu_operand2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80070000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_op2/S_AXI/Reg] SEG_axi_gpio_alu_op2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_res2/S_AXI/Reg] SEG_axi_gpio_alu_res2_Reg

  create_bd_addr_seg -range 0x00010000 -offset 0x80090000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_operand3/S_AXI/Reg] SEG_axi_gpio_alu_operand3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x800A0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_op3/S_AXI/Reg] SEG_axi_gpio_alu_op3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x800B0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_alu_res3/S_AXI/Reg] SEG_axi_gpio_alu_res3_Reg
